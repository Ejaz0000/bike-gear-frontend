      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mb-8">
          <h2 
            ...
            style={{ color: 'var(--neutral-gray900)' }}
          >
            Page Not Found
          </h2>
          <p 
        ...
        <div className="mt-12 flex justify-center gap-8 opacity-20">
          <div className="w-16 h-16 rounded-full" style={{ backgroundColor: 'var(--accent-orange)' }} />
          <div className="w-12 h-12 rounded-full" style={{ backgroundColor: 'var(--accent-orange)' }} />
          <div className="w-8 h-8 rounded-full" style={{ backgroundColor: 'var(--accent-orange)' }} />
        </div>
      </div>
    </div>
  );
