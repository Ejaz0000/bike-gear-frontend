          ...
          <div>
            ...
            {support?.phone && (
              <a
                ...
                className="flex items-center gap-4 text-[#ff6b35] font-semibold mb-6 no-underline transition-colors hover:text-orange-300"
              >
              ...
              <div className="flex flex-col gap-4">
                {column.links?.map((link, linkIdx) => (
                  <Link
                    key={linkIdx}
                    href={link.href}
                    className="text-sm text-gray-400 no-underline transition-colors hover:text-orange-400"
                  >
                    {link.label}
                  </Link>
                ))}
              ...
              <div className="flex gap-6">
                {support.socials.map((social, idx) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-md bg-[#ff6b35] flex items-center justify-center text-white no-underline transition-colors hover:bg-orange-600"
                    title={social.icon}
                  >
