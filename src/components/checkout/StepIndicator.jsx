...
export default function StepIndicator({ currentStep, totalSteps = 3 }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg mb-6" style={{ border: `1px solid var(--neutral-gray400)` }}>
          ...
          <div key={step.number} className="flex items-center flex-1">
            ...
            <div className="ml-3">
              ...
              <p
                ...
                style={{
                  color: step.number === currentStep ? 'var(--accent-orange)' : 'var(--neutral-gray600)',
                }}
              >
                {step.label}
              </p>
