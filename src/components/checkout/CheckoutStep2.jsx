...
export default function CheckoutStep2({
  ...
  return (
    <div className="bg-white p-6 rounded-lg" style={{ border: `1px solid var(--neutral-gray400)` }}>
      ...
      {isAuthenticated && (!user?.addresses || user.addresses.length === 0) && (
        <div className="mb-6 p-4 rounded-lg" style={{ backgroundColor: 'rgba(255, 152, 0, 0.1)', borderLeft: '4px solid var(--accent-orange)' }}>
