              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="p-3 rounded-lg" style={{ backgroundColor: 'rgba(0,0,0,0.02)' }}>
                    ...
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails.shipping_address?.street}</p>
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails.shipping_address?.city}, {orderDetails.shipping_address?.state} {orderDetails.shipping_address?.postal_code}</p>
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails.shipping_address?.country}</p>
                    <p style={{ color: 'var(--neutral-gray700)' }}>Phone: {orderDetails.shipping_address?.phone}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails.payment_method}</p>
                </div>
                {orderDetails.notes && (
                  <div>
                    <h3 className="font-semibold mb-2" style={{ color: 'var(--primary-main)' }}>Order Notes</h3>
                    <p style={{ color: 'var(--neutral-gray700)' }}>{orderDetails.notes}</p>
                  </div>
                )}
              </div>
            )}
